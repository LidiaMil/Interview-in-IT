  ...
  return (
    User && Categorey && <div className="job-card shadow border-radius">
      ...
      <div className="job-card-buttons">
        <Link to={`/interview/${id}`} className="active" >
